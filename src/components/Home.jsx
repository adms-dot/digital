...
const Home = () => {
  ...
  return (
    <div className=" h-full pt-10" style={{ backgroundColor: 'white' }}>
      {/* Hero Section */}
      <div className='flex h-screen justify-center '>
        <section className={`hero flex flex-col md:flex-row justify-between w-full pl-5 md:pl-32 bg-main bg-cover bg-end text-black transition-opacity duration-1000 ${HeadingVisible ? 'opacity-100' : 'opacity-0'} mt-16 pb-20 md:pb-44 h-3/4`}>
          <div className="text-center md:text-left">
            <h1 className={`text-4xl md:text-9xl pt-28 text-[#082522] transition-opacity duration-1000 font-bold ${TitleVisible ? 'opacity-100' : 'opacity-0'}`}>
              Boost your
            </h1>
            <h1 className={`text-4xl md:text-9xl text-[#082522] transition-opacity duration-1000 font-bold ${TitleVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {/* Services */}
      <section className="services px-12 ">
