...
const Services = () => {
  ...
  return (
    <div className="container  pt-20 mx-auto" style={{ backgroundColor: 'white' }}>
      {/* Hero Section */}
        ...
        {[
          ...
          <div key={index} className={`service flex flex-col bg-white rounded-lg shadow transition-opacity duration-1000 p-6 ${ServicesVisible[index] ? 'opacity-100' : 'opacity-0'}`}>
            <div className="flex-1 flex justify-center items-center mb-4">
              <img src={service.image} alt={service.title} className="h-64 bg-cover   object-cover rounded-md" />
            </div>
